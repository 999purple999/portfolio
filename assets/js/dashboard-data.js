// Auto-extracted from `gh repo list 999purple999` on 2026-05-28.
...
window.__METRICS = {
  ...
  // Repo dettaglio
  repos: [
    { name: 'cold-forge',        lang: 'Markdown',   stars: 0, public: true,  bytes: 53000,   pushedAt: '2026-05-28' },
    { name: 'portfolio',         lang: 'JavaScript', stars: 0, public: true,  bytes: 82461,   pushedAt: '2026-05-28' },
    { name: 'halcyon',           lang: 'JavaScript', stars: 0, public: true,  bytes: 196795,  pushedAt: '2026-05-24' },
  ...
  // Commit activity per mese ultimi 12 mesi (proxy: dimensione progetti new + push + upstream PRs)
  commitsMonthly: [
    ...
    { m: '2026-04', n: 38 }, { m: '2026-05', n: 95 }, { m: '2026-06', n: 0 },
  ],
};
